...
static void create_entrybox (g_items* obj)
{
...
static void create_buffers(g_items * obj)
{
...
static void create_radio_buttons(g_items* obj)
{
...
static void set_radio_buttons( g_items *obj)
{
// set values 
...
static void entry_box_cb(g_items *obj)
{
...
static void radio_button_callbacks( g_items * obj)
{
...
static void create_buttons_callbacks(g_items* obj)
{
